     ...
     <!-- Form tìm kiếm -->
        <div class="row mt-4">
            <div class="col-md-6 offset-md-3">
                <form action="blog.jsp" method="GET" class="d-flex">
...
%>
    ...
    <div class="pagination justify-content-center mt-4">
        <%-- Nút Previous --%>
        <% if (currentPage > 1) { %>
            <a class="btn btn-primary me-2" href="blog.jsp?page=<%= currentPage - 1 %>">Previous</a>
        <% } %>
        ...
        %>
            <a class="btn btn-primary me-2 <%= (i == currentPage) ? "active" : "" %>" href="blog.jsp?page=<%= i %>"><%= i %></a>
        <% } %>

        <%-- Nút Next --%>
        <% if (currentPage < (int) Math.ceil((double) totalPosts / postsPerPage)) { %>
            <a class="btn btn-primary" href="blog.jsp?page=<%= currentPage + 1 %>">Next</a>
        <% } %>
    </div>
</div>
