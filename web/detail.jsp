...
<html lang="en">
    ...
    <body>
                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div style="margin-top: 20px;">
                        <div class="description-box" style="height: auto; display: inline-block; padding: 20px; border: 1px solid #ccc; border-radius: 8px;">
                            ...
                            <br>
                            <div class="d-flex">
                                <a href="userRegisterClub?club_id=${clubId.club_id}" class="btn btn-primary flex-shrink-0" type="button">
                                    <i class="bi-cart-fill me-1"></i> Join
                                </a>
                            </div>
                    ...
                    <c:forEach items="${listBlogs}" var="blog">
                        <div class="col-md-6">
                            <div class="card mb-4 blog-card">
                                <img src="${blog.imageBlog}" class="card-img-top blog-image" alt="Blog Image">
                                <div class="card-body">
        ...
        <section class="py-5 bg-light">
            <div class="container px-4 px-lg-5 mt-5">
                <h2 class="fw-bolder mb-4">Các Câu Lạc Bộ Khác</h2>
